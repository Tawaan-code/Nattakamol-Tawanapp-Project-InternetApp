  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.header}>
        ...
        <TouchableOpacity onPress={() => setIsLoggedIn(false)}><Text style={{color: 'red'}}>Logout</Text></TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  productCard: { flexDirection: "row", backgroundColor: "white", padding: 12, borderRadius: 10, marginBottom: 12 },
  ...
  inputField: { borderWidth: 1, borderColor: '#ddd', borderRadius: 8, padding: 12, marginBottom: 15 },
